...
--
-- Host: 127.0.0.1    Database: softline
-- ------------------------------------------------------
...
CREATE DATABASE IF NOT EXISTS `softline` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `softline`;
...
CREATE TABLE `produtos` (
  ...
  `codigo_barras` varchar(14) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
