                ...
                <form action="{{ route('clientes.update', $cliente) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nome" value="{{ old('nome', $cliente->nome) }}" maxlength="60"
                        ...
                        <div>
                            ...
                            <input type="text" name="fantasia" value="{{ old('fantasia', $cliente->fantasia) }}" maxlength="100"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="endereco" rows="3"
                                class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm @error('endereco') border-red-500 @enderror">{{ old('endereco', $cliente->endereco) }}</textarea>
