            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg p-6">
                ...
                <form action="{{ route('produtos.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                Descrição * <span class="text-gray-400 text-xs">(máx. 60 caracteres)</span>
                            </label>
                            <input type="text" name="descricao" value="{{ old('descricao') }}" maxlength="60"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                Código de Barras <span class="text-gray-400 text-xs">(máx. 14 caracteres)</span>
                            </label>
                            <input type="text" name="codigo_barras" value="{{ old('codigo_barras') }}" maxlength="14"
                        ...
                        <div>
                            ...
                            <input type="text" name="valor_venda" value="{{ old('valor_venda') }}"
                                id="valor_venda"
                        ...
                        <div>
                            ...
                            <input type="text" name="peso_bruto" value="{{ old('peso_bruto') }}"
                                id="peso_bruto"
                        ...
                        <div>
                            ...
                            <input type="text" name="peso_liquido" value="{{ old('peso_liquido') }}"
                                id="peso_liquido"
